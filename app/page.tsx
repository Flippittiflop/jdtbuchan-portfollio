...
export default function Home() {
    ...
    useEffect(() => {
      ...
      if (video) {
        video.currentTime = Math.random() * 5; // Start at a random second
    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <div className="text-center">
        ...
        >
          <video
              ref={videoRef}
              src="/profile/profile.mp4" // MP4 for better performance
              muted
              loop
              playsInline
        ...
        {/*     className="relative w-64 h-64 mx-auto mb-8 rounded-full overflow-hidden">*/}
        {/*  <Image*/}
        {/*      src={isHovered ? "/profile/profile.gif" : "/profile/profile.jpg"} // Swap image on hover*/}
